  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Edit Hall</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Update hall name and address.</p>
        </div>
      </div>
      ...
      <EditHallForm
        ...
        currentDeviceCount={deviceCount ?? 0}
